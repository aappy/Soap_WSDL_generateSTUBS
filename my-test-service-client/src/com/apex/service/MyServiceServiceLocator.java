...
public class MyServiceServiceLocator extends org.apache.axis.client.Service implements com.apex.service.MyServiceService {
    ...
    private java.lang.String MyService_address = "http://localhost:8080/my-test-service/services/MyService";
    ...
    public com.apex.service.MyService getMyService() throws javax.xml.rpc.ServiceException {
    ...
    public com.apex.service.MyService getMyService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.apex.service.MyServiceSoapBindingStub _stub = new com.apex.service.MyServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.apex.service.MyService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.apex.service.MyServiceSoapBindingStub _stub = new com.apex.service.MyServiceSoapBindingStub(new java.net.URL(MyService_address), this);
                _stub.setPortName(getMyServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.apex.com", "MyServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.apex.com", "MyService"));
        }
